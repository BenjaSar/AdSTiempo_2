...
class BitcoinEDA:
    ...
    def _plot_comprehensive_eda(self):
        ...
        plt.savefig('informer/results/01_comprehensive_eda.png', dpi=300, bbox_inches='tight')
        print("   ✅ Saved: informer/results/01_comprehensive_eda.png")
        plt.close()
    ...
    def _plot_advanced_analysis(self):
        ...
        plt.tight_layout()
        plt.savefig('informer/results/02_advanced_analysis.png', dpi=300, bbox_inches='tight')
        print("   ✅ Saved: informer/results/02_advanced_analysis.png")
        plt.close()
